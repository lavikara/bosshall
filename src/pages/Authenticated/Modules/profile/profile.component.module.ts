...
const routes: Routes = [{
    ...
    children: [{
        ...
        path: 'interests',
        component: EditInterestsComponent
    }, {
        path: 'settings',
...
@NgModule({
    declarations: [UserProfileComponent, ProfileComponent, EditInterestsComponent, ProfileSettingsComponent, MyspreadComponent],
    ...
    exports: [UserProfileComponent, ProfileComponent, EditInterestsComponent, ProfileSettingsComponent, MyspreadComponent]
})
